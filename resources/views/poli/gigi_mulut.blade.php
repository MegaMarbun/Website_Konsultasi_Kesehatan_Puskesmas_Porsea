            ...
            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                <div class="d-flex flex-column">
                    ...
                    <p style="color: black;">Kesehatan mulut mengacu pada kesehatan gigi, gusi, dan seluruh sistem mulut-wajah yang memungkinkan kita untuk tersenyum, berbicara, dan mengunyah.
                        Penyakit yang paling umum yang mempengaruhi kesehatan mulut kita termasuk gigi berlubang (kerusakan gigi), penyakit gusi (periodontal), dan kanker mulut.</p>
                </div>
            </div>
            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                ...
                <form action="{{ url('konsultasi_umum') }}" method="POST">
                    ...
                    <div class="mb-3 mt-3">
                        ...
                        <input type="number" min="1" class="form-control" placeholder="Masukkan Tinggi anda" name="tinggi_badan" required autofocus>
                    </div>
                    <div class="mb-3 mt-3">
                        <label for="email" class="form-label">Golongan Darah:</label>
                        <input type="text" class="form-control" placeholder="Masukkan golongan darah anda" name="gol_darah" required autofocus>
                    </div>
                    <div class=" mb-3">
