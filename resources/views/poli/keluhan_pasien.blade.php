        ...
        <div class="row g-5">
            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                <div class="d-flex flex-column">
                    ...
                    <p style="color: black;">Keluhan pasien biasanya mengacu pada 'ekspresi keluhan' dan 'perselisihan dalam pengaturan perawatan kesehatan'. Pasien sering membuat surat resmi
                        yang ditulis ke organisasi kesehatan (atau regulator) setelah ambang ketidakpuasan dengan perawatan telah dilewati.Yang biasanya, keluhan dibuat oleh pasien atau keluarga.</p>
                </div>
            </div>
